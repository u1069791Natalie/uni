...
public class BookstoreBean extends AbstractBean implements Serializable {
    ...
    public String addSelected() {
        ...
        try {
            String isbn = (String) context().getExternalContext().
                    getSessionMap().get("isbn");
            Book book = bookRequestBean.getBook(isbn);
            cart.add(isbn, book);
            message(null, "ConfirmAdd", new Object[]{book.getTitle()});
    ...
    public String selectedDetails() {
        ...
        try {
            String isbn = (String) context().getExternalContext().getSessionMap().get("isbn");
            Book book = bookRequestBean.getBook(isbn);
