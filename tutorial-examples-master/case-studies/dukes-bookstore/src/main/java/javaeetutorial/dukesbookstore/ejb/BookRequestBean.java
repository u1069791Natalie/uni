...
public class BookRequestBean {
    ...
    public void createBook(String isbn, String surname, String firstname,
        ...
        try {
            Book book = new Book(isbn, surname, firstname, title, price,
    ...
    public Book getBook(String isbn) throws BookNotFoundException {
        Book requestedBook = em.find(Book.class, isbn);

        if (requestedBook == null) {
            throw new BookNotFoundException("Couldn't find book: " + isbn);
        }
    ...
    public void buyBook(String isbn, int quantity)
        ...
        try {
            ...
            throw new OrderException(
                    "Couldn't purchase book: " + isbn + ex.getMessage());
        }
    }
